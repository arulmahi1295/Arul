...
const Phlebotomy = () => {
    ...
    const handleCreateOrder = async () => {
        ...
        const orderData = {
            ...
            homeCollectionCharges: homeCollectionCharges, // Save to DB
            discount: discount,
    ...
    const handlePrintEstimate = () => {
        ...
        const estimateData = {
            // ...
            subtotal: calculateSubtotal(),
            homeCollectionCharges: homeCollectionCharges, // Add to Estimate
            discount: discount,
            totalAmount: calculateTotal(),
            isEstimate: true,
    ...
    const handleReset = () => {
        // ...
        setDiscount(0);
        setHomeCollectionCharges(0); // Reset
        setAdvancePaid(0);
        // ...
    };

    // ... In Return JSX, Add Input Input
